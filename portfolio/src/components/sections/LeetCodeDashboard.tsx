      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            <h2
              className={`text-4xl sm:text-5xl font-bold mb-4 flex items-center justify-center gap-3 ${
                theme === "dark" ? "text-white" : "text-gray-900"
              }`}
            >
                  ...
                  return (
                    ...
                    >
                      <div className="text-center mb-4">
                        <h4
                          className={`text-lg font-semibold mb-2 ${difficulty.textColor}`}
                        >
                          {difficulty.level}
                        </h4>
                        <div
                      ...
                      >
                        <motion.div
                          initial={{ width: 0 }}
                          animate={
                            inView ? { width: `${percentage}%` } : { width: 0 }
                          }
